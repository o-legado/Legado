...
async function carregarDados() {
    const resposta = await fetch("../../../assets/data/xtreinoPontosCorridos/equipe.json")
    equipes = await resposta.json()


    const resposta2 = await fetch("../../../assets/data/xtreinoPontosCorridos/jogadorers.json")
...
async function iniciarApp() {
    ...
    setTimeout(() => {
        window.dispatchEvent(new CustomEvent("dadosProntosXtreinoCorrido"));
    }, 50);
